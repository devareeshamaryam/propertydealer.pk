...
materials.forEach(material => {
  ...
  // Updated page.tsx with page content fetch
...
`;
  ...
  // Updated MaterialPageClient.tsx with page content display
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {pageContent && (
          <div className="mt-10 pt-8 border-t border-gray-200">
            {cmsPageTitle && (
              <h2 className="text-2xl font-bold mb-4">{cmsPageTitle}</h2>
            )}
            <div
...
`;
  ...
  console.log(`✅ Fixed ${material.slug}`);
});

console.log('\\n🎉 All 7 material rate pages fixed with page content support!');
