      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-10 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            Go to the Images Gallery in the dashboard to upload images. Once uploaded,
      ...
      <DialogContent className="max-w-4xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="flex flex-col flex-1 overflow-hidden gap-4">
          {allowUrlInput ? (
            <Tabs
              value={activeTab}
              onValueChange={(v) => setActiveTab(v as "gallery" | "url")}
                        ...
                        <img
                          src={
                            urlInput.trim().startsWith("http")
                              ...
                              ? `${typeof window !== "undefined" ? window.location.origin : ""}${urlInput.trim()}`
                              : urlInput.trim()
                          }
                          alt="URL preview"
