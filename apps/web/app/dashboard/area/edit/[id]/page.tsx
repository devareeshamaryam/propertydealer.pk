...
export default function EditAreaPage() {
  ...
  const [cities, setCities] = useState<
    Array<{ _id: string; name: string; state?: string; country?: string }>
  >([]);
    ...
    areaApi
      ...
      .then((area) => {
        ...
        form.reset({
          name: area.name || "",
          city:
            typeof area.city === "string" ? area.city : area.city?._id || "",
      ...
      .catch((error: any) => {
        toast.error("Error", {
          description: error?.response?.data?.message || "Failed to load area.",
        });
                      ...
                      <FormControl>
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            form.setValue(
                              "canonicalUrl",
                              `https://propertydealer.pk/area/${slug}`,
                            );
                          }}
                        />
                      </FormControl>
                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100 space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Area Description (Rich Text – General)
                        </FormLabel>
                        <FormControl>
                          <RichEditor
                            value={field.value || ""}
                ...
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-100 space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue-700">
                      Rent Page SEO & Content
                    </h3>
                    <p className="text-sm text-blue-500">
                      Shown on pages like /properties/rent/city/area. If left
                      empty, general SEO is used.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="e.g. Houses for Rent in DHA Phase 5"
                              {...field}
                              value={field.value || ""}
                            />
                          </FormControl>
                ...
                <div className="p-4 bg-green-50 rounded-lg border border-green-100 space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-green-700">
                      Sale Page SEO & Content
                    </h3>
                    <p className="text-sm text-green-500">
                      Shown on pages like /properties/sale/city/area. If left
                      empty, general SEO is used.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="e.g. Houses for Sale in DHA Phase 5"
                              {...field}
                              value={field.value || ""}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="Sale meta description"
                              {...field}
                              value={field.value || ""}
                            />
                          </FormControl>
